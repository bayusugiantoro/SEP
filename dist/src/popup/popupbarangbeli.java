 ...
 * @author Asus
 */
public class popupbarangbeli extends javax.swing.JFrame {
private Connection conn = new koneksi().connect();
private DefaultTableModel tabmode;

public beli barang = null;
    /**
     * Creates new form popupbarangbeli
     */
    public popupbarangbeli() {
        initComponents();
        datatable();
    }
    ...
    private void initComponents() {
        ...
        txtcaripopupbarang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtcaripopupbarangActionPerformed(evt);
            }
        });
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 1130, 110));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("DATA BARANG");
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 20, -1, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 1160, 190));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1180, 250));

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void txtcaripopupbarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtcaripopupbarangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtcaripopupbarangActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popupbarangbeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popupbarangbeli().setVisible(true);
            }
        });
    }
